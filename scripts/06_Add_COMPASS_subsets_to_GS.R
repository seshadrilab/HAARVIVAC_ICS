...
sum(cd4_pop_counts$CD4_COMPASS_Subsets) # 61272
...
sum(cd4_indiv_pop_counts$CD4_COMPASS_Subsets) # 61272
...
sum(cd8_pop_counts$CD8_COMPASS_Subsets) # 11807
...
sum(cd8_indiv_pop_counts$CD8_COMPASS_Subsets) # 11807
