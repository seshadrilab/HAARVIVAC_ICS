...
post_ifng_cd154_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(ifng_cd154_counts, current_stim = n, num_comparisons = length(stims), compare_time = FALSE, keep = "POST", 
...
conv_ifng_cd107a_plots <- purrr::pmap(.l = list(stims[-3]),
                               .f = function(n) {
                                 make_mag_plots(ifng_cd107a_counts, current_stim = n, num_comparisons = length(stims), compare_time = TRUE, keep = "Conv",
                                                groups_to_compare = c("Conv PRE", "Conv POST"), paired = TRUE, fill_colors = fill_colors,
                                                group_by_colname = "Group", subtitle = paste0("IFN", "\U03B3", "+CD107a+"), y_axis_text = "% CD4+ T Cells",
...
conv_s2_ifng_cd107a_plot <- make_mag_plots(counts = ifng_cd107a_counts, counts_no_outlier = ifng_cd107a_counts_no_outlier, current_stim = "S2", num_comparisons = length(stims),
...
post_ifng_cd107a_plots <- purrr::pmap(.l = list(stims[-2]),
                               .f = function(n) {
                                 make_mag_plots(ifng_cd107a_counts, current_stim = n, num_comparisons = length(stims), compare_time = FALSE, keep = "POST", 
                                                groups_to_compare = c("Naive POST", "Conv POST"), paired = FALSE, fill_colors = fill_colors, 
                                                group_by_colname = "Group", subtitle = paste0("IFN", "\U03B3", "+CD107a+"), y_axis_text = "% CD4+ T Cells",
...
post_s1_ifng_cd107a_plot <- make_mag_plots(counts = ifng_cd107a_counts, counts_no_outlier = ifng_cd107a_counts_no_outlier, current_stim = "S1", num_comparisons = length(stims),
...
naive_cd107a_hladr_cd38_plots <- purrr::pmap(.l = list(stims[-1]),
                               .f = function(n) {
                                 make_mag_plots(cd107a_hladr_cd38_counts, current_stim = n, num_comparisons = length(stims)-1, compare_time = TRUE, keep = "Naive",
                                                groups_to_compare = c("Naive PRE", "Naive POST"), paired = TRUE, fill_colors = fill_colors,
