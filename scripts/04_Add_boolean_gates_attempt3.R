...
# Reformat the boolean subsets in string format (e.g., CD4+/IL2+&CD4+/IFNg+&!CD4+/TNFa+)
...
# Assign shorter names to each boolean subset in the list
...
## Save GatingSet ##
#save_gs(gs, here::here("out/GatingSets/HAARVIVAC_GatingSet_with_bool3"))
#gs <- load_gs(here::here("out/GatingSets/HAARVIVAC_GatingSet_with_bool3"))
