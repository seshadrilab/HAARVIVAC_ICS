...
naive_act_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(act_counts, current_stim = n, compare_time = TRUE, keep = "Naive", groups_to_compare = c("Naive PRE", "Naive POST"),
                                                paired = TRUE, fill_colors = fill_colors, group_by_colname = "Group", subtitle = "HLA-DR+CD38+", 
                                                y_axis_text = "% COMPASS-selected CD4+ T Cells", y_axis_size = 15)
                               })
...
conv_act_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(act_counts, current_stim = n, compare_time = TRUE, keep = "Conv", groups_to_compare = c("Conv PRE", "Conv POST"), 
                                                paired = TRUE, fill_colors = fill_colors, group_by_colname = "Group", subtitle = "HLA-DR+CD38+", 
                                                y_axis_text = "% COMPASS-selected CD4+ T Cells", y_axis_size = 15)
                               })
...
pre_act_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(act_counts, current_stim = n, compare_time = FALSE, keep = "PRE", groups_to_compare = c("Naive PRE", "Conv PRE"),
...
post_act_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(act_counts, current_stim = n, compare_time = FALSE, keep = "POST", groups_to_compare = c("Naive POST", "Conv POST"),
                                                paired = FALSE, fill_colors = fill_colors, group_by_colname = "Group", subtitle = "HLA-DR+CD38+", 
                                                y_axis_text = "% COMPASS-selected CD4+ T Cells", y_axis_size = 15)
                               })
...
naive_cd38_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(cd38_counts, current_stim = n, compare_time = TRUE, keep = "Naive", groups_to_compare = c("Naive PRE", "Naive POST"),
...
conv_cd38_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(cd38_counts, current_stim = n, compare_time = TRUE, keep = "Conv", groups_to_compare = c("Conv PRE", "Conv POST"),
                                                paired = TRUE, fill_colors = fill_colors, group_by_colname = "Group", subtitle = "CD38+", 
                                                y_axis_text = "% COMPASS-selected CD4+ T Cells", y_axis_size = 15,  ylim = c(0, 65))
                               })
...
pre_cd38_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(cd38_counts, current_stim = n, compare_time = FALSE, keep = "PRE", groups_to_compare = c("Naive PRE", "Conv PRE"),
...
post_cd38_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(cd38_counts, current_stim = n, compare_time = FALSE, keep = "POST", groups_to_compare = c("Naive POST", "Conv POST"),
                                                paired = FALSE, fill_colors = fill_colors, group_by_colname = "Group", subtitle = "CD38+", 
                                                y_axis_text = "% COMPASS-selected CD4+ T Cells", y_axis_size = 15)
                               })
...
naive_hladr_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(hladr_counts, current_stim = n, compare_time = TRUE, keep = "Naive", groups_to_compare = c("Naive PRE", "Naive POST"),
...
conv_hladr_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(hladr_counts, current_stim = n, compare_time = TRUE, keep = "Conv", groups_to_compare = c("Conv PRE", "Conv POST"),
                                                paired = TRUE, fill_colors = fill_colors, group_by_colname = "Group", subtitle = "HLA-DR+", 
                                                y_axis_text = "% COMPASS-selected CD4+ T Cells", y_axis_size = 15,  ylim = c(0, 20))
                               })
...
pre_hladr_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(hladr_counts, current_stim = n, compare_time = FALSE, keep = "PRE", groups_to_compare = c("Naive PRE", "Conv PRE"),
...
post_hladr_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(hladr_counts, current_stim = n, compare_time = FALSE, keep = "POST", groups_to_compare = c("Naive POST", "Conv POST"),
                                                paired = FALSE, fill_colors = fill_colors, group_by_colname = "Group", subtitle = "HLA-DR+",
                                                y_axis_text = "% COMPASS-selected CD4+ T Cells", y_axis_size = 15)
                               })
...
naive_cm_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(cm_counts, current_stim = n, compare_time = TRUE, keep = "Naive", groups_to_compare = c("Naive PRE", "Naive POST"),
...
conv_cm_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(cm_counts, current_stim = n, compare_time = TRUE, keep = "Conv", groups_to_compare = c("Conv PRE", "Conv POST"), 
                                                paired = TRUE, fill_colors = fill_colors, group_by_colname = "Group", subtitle = "Central Memory (CD45RA-CCR7+)",
                                                y_axis_text = "% COMPASS-selected CD4+ T Cells", y_axis_size = 15)
                               })
...
pre_cm_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(cm_counts, current_stim = n, compare_time = FALSE, keep = "PRE", groups_to_compare = c("Naive PRE", "Conv PRE"),
...
post_cm_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(cm_counts, current_stim = n, compare_time = FALSE, keep = "POST", groups_to_compare = c("Naive POST", "Conv POST"),
                                                paired = FALSE, fill_colors = fill_colors, group_by_colname = "Group", subtitle = "Central Memory (CD45RA-CCR7+)",
                                                y_axis_text = "% COMPASS-selected CD4+ T Cells", y_axis_size = 15)
                               })
...
naive_em_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(em_counts, current_stim = n, compare_time = TRUE, keep = "Naive", groups_to_compare = c("Naive PRE", "Naive POST"),
                                                paired = TRUE, fill_colors = fill_colors, group_by_colname = "Group", subtitle = "Effector Memory (CD45RA-CCR7-)",
                                                y_axis_text = "% COMPASS-selected CD4+ T Cells", y_axis_size = 15,   ylim = c(0, 100))
                               })
...
conv_em_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(em_counts, current_stim = n, compare_time = TRUE, keep = "Conv", groups_to_compare = c("Conv PRE", "Conv POST"), 
                                                paired = TRUE, fill_colors = fill_colors, group_by_colname = "Group", subtitle = "Effector Memory (CD45RA-CCR7-)",
                                                y_axis_text = "% COMPASS-selected CD4+ T Cells", y_axis_size = 15,  ylim = c(0, 65))
                               })
...
pre_em_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(em_counts, current_stim = n, compare_time = FALSE, keep = "PRE", groups_to_compare = c("Naive PRE", "Conv PRE"), 
...
post_em_plots <- purrr::pmap(.l = list(stims),
                               .f = function(n) {
                                 make_mag_plots(em_counts, current_stim = n, compare_time = FALSE, keep = "POST", groups_to_compare = c("Naive POST", "Conv POST"),
                                                paired = FALSE, fill_colors = fill_colors, group_by_colname = "Group", subtitle = "Effector Memory (CD45RA-CCR7-)",
                                                y_axis_text = "% COMPASS-selected CD4+ T Cells", y_axis_size = 15)
                               })
