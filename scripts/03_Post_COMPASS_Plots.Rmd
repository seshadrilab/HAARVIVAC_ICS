...
```{r save boxplots pdf}
if(save_output) {
  cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD4_naive_boxplots.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
  ...
  dev.off()
    ...
    cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD4_conv_boxplots.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
  ...
  dev.off()
    ...
    cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD8_naive_boxplots.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
  ...
  dev.off()
    ...
    cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD8_conv_boxplots.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
  ...
  dev.off()
    ...
    cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD4_pre_boxplots.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
  ...
  dev.off()
    ...
    cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD8_pre_boxplots.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
  ...
  dev.off()
      ...
      cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD4_post_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
  ...
  dev.off()
    ...
    cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD8_post_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
