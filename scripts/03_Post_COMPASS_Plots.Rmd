...
cytokine_row_name_text = c("CD154", "IL-2", paste0("TNF", "\U03B1"), "CD107a", "IL-4/5/13", "IL17a", paste0("IFN", "\U03B3")) # make sure this is in the same order as "cytokine_order_for_annotation"
group_colors <- c("Naive PRE" = "#A6CEE3", "Naive POST" = "#1F78B4", "Conv PRE" = "#FB9A99", "Conv POST" = "#E31A1C")
...
draw(cd4_naive_heatmap, gap = unit(0.1, "in"), merge_legends = T)
...
draw(cd4_conv_heatmap, gap = unit(0.1, "in"), merge_legends = T)
```
...
draw(cd8_naive_heatmap, gap = unit(0.1, "in"), merge_legends = T)
...
draw(cd8_conv_heatmap, gap = unit(0.1, "in"), merge_legends = T)
```
...
cytokine_order_for_annotation = c("CD154", "IL2", "TNFa", "CD107a", "IL4_5_13", "IL17a", "IFNg")
cytokine_row_name_text = c("CD154", "IL-2", paste0("TNF", "\U03B1"), "CD107a", "IL-4/5/13", "IL17a", paste0("IFN", "\U03B3")) # make sure this is in the same order as "cytokine_order_for_annotation"
naive_group_colors <- c("Naive PRE" = "#A6CEE3", "Naive POST" = "#1F78B4")
conv_group_colors <- c("Conv PRE" = "#FB9A99", "Conv POST" = "#E31A1C")
```
...
cytokine_order_for_annotation = c("CD154", "IL2", "TNFa", "CD107a", "IL4_5_13", "IL17a", "IFNg")
cytokine_row_name_text = c("CD154", "IL-2", paste0("TNF", "\U03B1"), "CD107a", "IL-4/5/13", "IL17a", paste0("IFN", "\U03B3")) # make sure this is in the same order as "cytokine_order_for_annotation"
pre_group_colors <- c("Naive PRE" = "#A6CEE3", "Conv PRE" = "#FB9A99")
```
...
cytokine_order_for_annotation = c("CD154", "IL2", "TNFa", "CD107a", "IL4_5_13", "IL17a", "IFNg")
cytokine_row_name_text = c("CD154", "IL-2", paste0("TNF", "\U03B1"), "CD107a", "IL-4/5/13", "IL17a", paste0("IFN", "\U03B3")) # make sure this is in the same order as "cytokine_order_for_annotation"
post_group_colors <- c("Naive POST" = "#1F78B4", "Conv POST" = "#E31A1C")
```
...
```{r}
naive_pre_fs_plot <- fs_pfs_plot(df = fs_pfs_df, FS_or_PFS = "FS", cd4_or_cd8 = "CD4", group = "Naive PRE")
naive_pre_fs_plot

conv_pre_fs_plot <- fs_pfs_plot(df = fs_pfs_df, FS_or_PFS = "FS", cd4_or_cd8 = "CD4", group = "Conv PRE")
conv_pre_fs_plot
```
...
```{r}
naive_pre_pfs_plot <- fs_pfs_plot(df = fs_pfs_df, FS_or_PFS = "PFS", cd4_or_cd8 = "CD4", group = "Naive PRE")
naive_pre_pfs_plot

conv_pre_pfs_plot <- fs_pfs_plot(df = fs_pfs_df, FS_or_PFS = "PFS", cd4_or_cd8 = "CD4", group = "Conv PRE")
conv_pre_pfs_plot
```

# Split FS plots

Same as previous plots, except split up by infection status or timepoint
...
n_fs_plots <- pmap(list(rep(c("S1", "S2", "NCAP"), times = 2),
                           ...
                           function(current_stim, cd4_or_cd8) {
                             split_fs_pfs_plot("FS", current_stim, cd4_or_cd8,
                                         compare_naive = TRUE,
                                         compare_intra = TRUE)
                           })
...
```{r, fig.width=4, fig.height=5}
post_fs_plots <- pmap(list(rep(c("S1", "S2", "NCAP"), times = 2),
                           rep(c("CD4", "CD8"), each = 3)),
                           function(current_stim, cd4_or_cd8) {
                             split_fs_pfs_plot("FS", current_stim, cd4_or_cd8,
                                         compare_POST = TRUE)
                           })
names(post_fs_plots) <- paste0(rep(c("CD4", "CD8"), each = 3), "_", rep(c("S1", "S2", "NCAP"), times = 2))
post_fs_plots
```
...
```{r save heatmaps pdf}
if(save_output) {
  cairo_pdf(file=here::here("out/post_compass_plots/CD4_naive_COMPASS_Heatmap.pdf"), width=9, height=8,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
  print(draw(cd4_naive_heatmap, gap = unit(0.1, "in"), merge_legends = T))
  dev.off()
  
  cairo_pdf(file=here::here("out/post_compass_plots/CD4_conv_COMPASS_Heatmap.pdf"), width=9, height=8,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica
  print(draw(cd4_conv_heatmap, gap = unit(0.1, "in"), merge_legends = T))
  dev.off()
  
  cairo_pdf(file=here::here("out/post_compass_plots/CD8_naive_COMPASS_Heatmap.pdf"), width=9, height=8,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica
  print(draw(cd8_naive_heatmap, gap = unit(0.1, "in"), merge_legends = T))
  dev.off()
  
  cairo_pdf(file=here::here("out/post_compass_plots/CD8_conv_COMPASS_Heatmap.pdf"), width=9, height=8,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica
  print(draw(cd8_conv_heatmap, gap = unit(0.1, "in"), merge_legends = T))
  dev.off()
}
```
...
```{r save boxplots pdf}
if(save_output) {
  cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD4_naive_s1_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
  print(grid.draw(cd4_naive_bg_corr_boxplots[["CD4_S1"]]$Plot))
  dev.off()
  
  cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD4_naive_s2_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica
  print(grid.draw(cd4_naive_bg_corr_boxplots[["CD4_S2"]]$Plot))
  dev.off()
  
  cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD4_naive_ncap_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica
  print(grid.draw(cd4_naive_bg_corr_boxplots[["CD4_NCAP"]]$Plot))
  dev.off()
  
    cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD4_conv_s1_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
  print(grid.draw(cd4_conv_bg_corr_boxplots[["CD4_S1"]]$Plot))
  dev.off()
  
  cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD4_conv_s2_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica
  print(grid.draw(cd4_conv_bg_corr_boxplots[["CD4_S2"]]$Plot))
  dev.off()
  
  cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD4_conv_ncap_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica
  print(grid.draw(cd4_conv_bg_corr_boxplots[["CD4_NCAP"]]$Plot))
  dev.off()
  
    cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD8_naive_s1_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
  print(grid.draw(cd8_naive_bg_corr_boxplots[["CD8_S1"]]$Plot))
  dev.off()
  
  cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD8_naive_s2_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica
  print(grid.draw(cd8_naive_bg_corr_boxplots[["CD8_S2"]]$Plot))
  dev.off()
  
  cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD8_naive_ncap_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica
  print(grid.draw(cd8_naive_bg_corr_boxplots[["CD8_NCAP"]]$Plot))
  dev.off()
  
    cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD8_conv_s1_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
  print(grid.draw(cd8_conv_bg_corr_boxplots[["CD8_S1"]]$Plot))
  dev.off()
  
  cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD8_conv_s2_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica
  print(grid.draw(cd8_conv_bg_corr_boxplots[["CD8_S2"]]$Plot))
  dev.off()
  
  cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD8_conv_ncap_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica
  print(grid.draw(cd8_conv_bg_corr_boxplots[["CD8_NCAP"]]$Plot))
  dev.off()
  
    cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD4_pre_s1_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
  print(grid.draw(cd4_pre_bg_corr_boxplots[["CD4_S1"]]$Plot))
  dev.off()
  
  cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD4_pre_s2_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica
  print(grid.draw(cd4_pre_bg_corr_boxplots[["CD4_S2"]]$Plot))
  dev.off()
  
  cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD4_pre_ncap_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica
  print(grid.draw(cd4_pre_bg_corr_boxplots[["CD4_NCAP"]]$Plot))
  dev.off()
  
    cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD8_pre_s1_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
  print(grid.draw(cd8_pre_bg_corr_boxplots[["CD8_S1"]]$Plot))
  dev.off()
  
  cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD8_pre_s2_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica
  print(grid.draw(cd8_pre_bg_corr_boxplots[["CD8_S2"]]$Plot))
  dev.off()
  
  cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD8_pre_ncap_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica
  print(grid.draw(cd8_pre_bg_corr_boxplots[["CD8_NCAP"]]$Plot))
  dev.off()
  
      cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD4_post_s1_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
  print(grid.draw(cd4_post_bg_corr_boxplots[["CD4_S1"]]$Plot))
  dev.off()
  
  cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD4_post_s2_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica
  print(grid.draw(cd4_post_bg_corr_boxplots[["CD4_S2"]]$Plot))
  dev.off()
  
  cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD4_post_ncap_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica
  print(grid.draw(cd4_post_bg_corr_boxplots[["CD4_NCAP"]]$Plot))
  dev.off()
  
    cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD8_post_s1_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
  print(grid.draw(cd8_post_bg_corr_boxplots[["CD8_S1"]]$Plot))
  dev.off()
  
  cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD8_post_s2_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica
  print(grid.draw(cd8_post_bg_corr_boxplots[["CD8_S2"]]$Plot))
  dev.off()
  
  cairo_pdf(file=here::here("out/post_compass_plots/magnitude_plots/CD8_post_ncap_boxplot.pdf"), width=10, height=7,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica
  print(grid.draw(cd8_post_bg_corr_boxplots[["CD8_NCAP"]]$Plot))
  dev.off()
}
```
...
if(save_output) {
  cairo_pdf(file=here::here("out/post_compass_plots/fs_plots/naive_pre_fs_plots.pdf"), width=6, height=5,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
  print(naive_pre_fs_plot)
  dev.off()
  
  cairo_pdf(file=here::here("out/post_compass_plots/fs_plots/conv_pre_fs_plots.pdf"), width=6, height=5,
        onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
